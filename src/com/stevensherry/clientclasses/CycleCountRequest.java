...
public class CycleCountRequest extends Request {
  ...
  public CycleCountRequest(String dateRequested, String requestor) {
    super(dateRequested, requestor);
    this.inventoryItems = new ArrayList<>();
  }

  public CycleCountRequest(String dateRequested, String requestor, String id) {
    super(dateRequested, requestor, id);
    this.inventoryItems = new ArrayList<>();
  }

  public CycleCountRequest(String dateRequested, String requestor, String... inventoryItems) {
    this(dateRequested, requestor);
    this.inventoryItems = new ArrayList<>(Arrays.asList(inventoryItems));
  }

  public CycleCountRequest(String dateRequested, String requestor, String id, String... inventoryItems) {
